...
const TestimonySection = ({ testimonies }: TestimonySectionProps) => {
  ...
  return (
    <Section>
      <div className="flex flex-col gap-6 lg:grid lg:grid-cols-3 lg:grid-rows-6 lg:gap-10">
        ...
        <TestimonyContainer testimonies={testimonies.data} />
      </div>
    </Section>
  )
}

const TestimonyContainer = ({ testimonies}: TestimonyContainerProps) => {
